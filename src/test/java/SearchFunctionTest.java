...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
    ...
    void search_함수_Mock_Test() throws ParseException {
        ...
        when(icrudManager.calc("SCH,-p,-d, ,birthday,04"))
                .thenReturn("SCH,02117175,SBILHUT LDEXRI,CL4,010-2814-1699,19950704,ADV");

        when(icrudManager.calc("SCH, , , ,employeeNum,79110836"))
                .thenReturn("SCH,88114052,NQ LVARW,CL4,010-4528-3059,19911021,PRO");

        when(icrudManager.calc("SCH,-p, , ,certi,PRO"))
                .thenReturn("SCH,88114052,NQ LVARW,CL4,010-4528-3059,19911021,PRO\n" +
                        "SCH,01122329,DN WD,CL4,010-7174-5680,20071117,PRO\n" +
                        "SCH,03113260,HH LTUPF,CL2,010-5798-5383,19791018,PRO\n" +
                        "SCH,05101762,VCUHLE HMU,CL4,010-3988-9289,20030819,PRO\n" +
        ...
        when(icrudManager.calc("SCH, , , ,certi,ADV"))
                .thenReturn("SCH,6");
