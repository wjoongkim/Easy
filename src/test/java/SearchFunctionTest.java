...
public class SearchFunctionTest {
    ...
    void getEmployeeMeberString_Test(){
        ...
        CRUDManager crudManager = new Search(m);

        String expectedVal = (new Employee("02117175"
                , new Name("SBILHUT LDEXRI")
                , "CL4"
                , new Phone("010-2814-1699")
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
    ...
    void search_함수_Mock_Test() throws ParseException {
        ...
        when(employeeManager.search.calc("SCH,-p,-d, ,birthday,04"))
                .thenReturn(String.valueOf(firstCondi));
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
        thirdCondi.add(new Employee("08123556"
                ...
                , "PRO"
                , 1908123556));
        when(employeeManager.search.calc("SCH,-p, , ,certi,PRO"))
                .thenReturn(String.valueOf(thirdCondi));
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
        fourthCondi.add(new Employee("08123557"
                ...
                , "PRO"
                , 2008123557));
        when(employeeManager.search.calc("SCH, , , ,certi,ADV"))
                .thenReturn(String.valueOf(fourthCondi));
        ...
        assertEquals(firstCondi, employeeManager.search.calc("SCH,-p,-d, ,birthday,04"));
        assertEquals(secondCondi, employeeManager.search.calc("SCH, , , ,employeeNum,79110836"));
        assertEquals(thirdCondi, employeeManager.search.calc("SCH,-p, , ,certi,PRO"));
        assertEquals(fourthCondi, employeeManager.search.calc("SCH, , , ,certi,ADV"));
    }
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
        ...
        assertEquals( expectedVal2, search.getEmpNoList( "SCH,-p,-m, ,phone,79"));
        ArrayList<String> expectedVal3 = new ArrayList<>();
        expectedVal3.add("05101762");
        assertEquals( expectedVal3, search.getEmpNoList( "SCH,-p,-l, ,phone,92"));
        ArrayList<String> expectedVal4 = new ArrayList<>();
        expectedVal4.add("05101762");
        assertEquals( expectedVal4, search.getEmpNoList( "SCH,-p,-l, ,phone,92"));
    ...
    void search_함수_Test() {
        ...
        employeeManager.add.calc("ADD, , , ,18115040,TTETHU HBO,CL3,010-4581-2050,20080718,ADV");
        employeeManager.add.calc("ADD, , , ,88114052,NQ LVARW,CL4,010-4528-3059,19911021,PRO");
        employeeManager.add.calc("ADD, , , ,19129568,SRERLALH HMEF,CL2,010-3091-9521,19640910,PRO");
        employeeManager.add.calc("ADD, , , ,17111236,VSID TVO,CL1,010-3669-1077,20120718,PRO");
        employeeManager.add.calc("ADD, , , ,18117906,TWU QSOLT,CL4,010-6672-7186,20030413,PRO");
        employeeManager.add.calc("ADD, , , ,08123556,WN XV,CL1,010-7986-5047,20100614,PRO");
        employeeManager.add.calc("ADD, , , ,02117175,SBILHUT LDEXRI,CL4,010-2814-1699,19950704,ADV");
        employeeManager.add.calc("ADD, , , ,03113260,HH LTUPF,CL2,010-5798-5383,19791018,PRO");
        employeeManager.add.calc("ADD, , , ,14130827,RPO JK,CL4,010-3231-1698,20090201,ADV");
        employeeManager.add.calc("ADD, , , ,01122329,DN WD,CL4,010-7174-5680,20071117,PRO");
        employeeManager.add.calc("ADD, , , ,08108827,RTAH VNUP,CL4,010-9031-2726,19780417,ADV");
        employeeManager.add.calc("ADD, , , ,85125741,FBAH RTIJ,CL1,010-8900-1478,19780228,ADV");
        employeeManager.add.calc("ADD, , , ,08117441,BMU MPOSXU,CL3,010-2703-3153,20010215,ADV");
        employeeManager.add.calc("ADD, , , ,10127115, KBU MHU, CL3, 010 - 3284 - 4054, 19660814, ADV");
        employeeManager.add.calc("ADD, , , ,12117017,LFIS JJIVL,CL1,010-7914-4067,20120812,PRO");
        employeeManager.add.calc("ADD, , , ,11125777, TKOQKIS HC, CL1, 010 - 6734 - 2289, 19991001, PRO");
        employeeManager.add.calc("ADD, , , ,11109136,QKAHCEX LTODDO,CL4,010-2627-8566,19640130,PRO");
        employeeManager.add.calc("ADD, , , ,05101762,VCUHLE HMU,CL4,010-3988-9289,20030819,PRO");
