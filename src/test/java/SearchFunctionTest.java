...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
    ...
    void search_함수_Mock_Test() throws ParseException {
        ...
        when(employeeManager.getSearch().calc("SCH,-p,-d, ,birthday,04"))
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
        thirdCondi.add(new Employee("08123556"
                ...
                , "PRO"
                , 1908123556));
        when(employeeManager.getSearch().calc("SCH,-p, , ,certi,PRO"))
...
//        SCH,08123556,WN XV,CL1,010-7986-5047,20100614,PRO
        fourthCondi.add(new Employee("08123557"
                ...
                , "PRO"
                , 2008123557));
        when(employeeManager.getSearch().calc("SCH, , , ,certi,ADV"))
        ...
        assertEquals(firstCondi, employeeManager.getSearch().calc("SCH,-p,-d, ,birthday,04"));
        assertEquals(secondCondi, employeeManager.getSearch().calc("SCH, , , ,employeeNum,79110836"));
        assertEquals(thirdCondi, employeeManager.getSearch().calc("SCH,-p, , ,certi,PRO"));
        assertEquals(fourthCondi, employeeManager.getSearch().calc("SCH, , , ,certi,ADV"));
    }
