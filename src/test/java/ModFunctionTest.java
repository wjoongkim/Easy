...
public class ModFunctionTest {
    ...
    void EmployeeListTest() {
        ...
        manager.add("15123099,VXIHXOTH JHOP,CL3,010-3112-2609,19771211,ADV");
        manager.add("17112609,FB NTAWR,CL4,010-5645-6122,19861203,PRO");
        manager.add("18115040,TTETHU HBO,CL3,010-4581-2050,20080718,ADV");
        manager.add("88114052,NQ LVARW,CL4,010-4528-3059,19911021,PRO");
        manager.add("19129568,SRERLALH HMEF,CL2,010-3091-9521,19640910,PRO");
        manager.add("17111236,VSID TVO,CL1,010-3669-1077,20120718,PRO");
        manager.add("18117906,TWU QSOLT,CL4,010-6672-7186,20030413,PRO");
        manager.add("01122329,DN WD,CL4,010-7174-5680,20071117,PRO");

        MOD mod = new MOD(list);
        System.out.println(mod.Run("MOD,-p, , ,name,FB NTAWR,cl,CL3"));
